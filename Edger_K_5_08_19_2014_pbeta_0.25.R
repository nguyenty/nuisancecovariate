...
edger_out_5_25 <- llply(1:length(i.beta), function(j){
...
head(edger_out_5_25[[1]])
head(edger_out_5_25[[2]])
save(edger_out_5_25, file = paste(mainDir1, "/edger/edger_out_5_25.RData", sep = ""))
