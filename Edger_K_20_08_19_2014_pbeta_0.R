...
edger_out_20_0 <- llply(1:length(i.beta), function(j){
...
head(edger_out_20_0[[1]])
head(edger_out_20_0[[2]])
save(edger_out_20_0, file = paste(mainDir1, "/edger/edger_out_20_0.RData", sep = ""))
