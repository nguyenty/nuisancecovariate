...
edger_out_20_50 <- llply(1:length(i.beta), function(j){
...
head(edger_out_20_50[[1]])
head(edger_out_20_50[[2]])
save(edger_out_20_50, file = paste(mainDir1, "/edger/edger_out_20_50.RData", sep = ""))
