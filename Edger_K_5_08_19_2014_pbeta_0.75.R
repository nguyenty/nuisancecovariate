...
edger_out_5_75 <- llply(1:length(i.beta), function(j){
...
head(edger_out_5_75[[1]])
head(edger_out_5_75[[2]])
save(edger_out_5_75, file = paste(mainDir1, "/edger/edger_out_5_75.RData", sep = ""))
